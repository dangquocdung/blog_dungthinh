...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <?php /* ?><li><a href="<?php echo $url;?>/admin/services"><i class="fa fa-cog"></i> Services </a></li>
                  ...
                  <li><a href="<?php echo $url;?>/admin/slideshow"><i class="fa fa-picture-o"></i> Slideshow </a></li><?php */?>
                  ...
                  <li><a href="<?php echo $url;?>/admin/pages"><i class="fa fa-sticky-note"></i> Pages </a></li>
                   ...
                   <li><a href="<?php echo $url;?>/admin/membership"><i class="fa fa-sticky-note"></i> Membership </a></li>
